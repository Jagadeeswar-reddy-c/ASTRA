...
| CR-006 | 2026-09-24 | change-requests/CR-006-astra-stack.md, studies/astra-stack-modules.md | Approved | Sponsor | Stackable 1-GPU bricks on a PCIe star (ADR-0014); D1–D5 as recommended |
| CR-007 | 2026-09-24 | change-requests/CR-007-backplane-pcb.md, 03-solution-design/backplane-pcb-spec.md | Proposed | Sponsor | ASTRA backplane PCB (Gen4 P2P switch, per-slot power telemetry); B1–B4 open |
